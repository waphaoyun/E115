...
String miaoshu=req.getParameter("description");
        ...
        //    String sql = "update ecu_file set description='"+ miaoshu+ "'   where id= "+uid;
            String sql = "update "+Mysql.getCar_name() +" set description='"+ miaoshu+ "'   where id= "+uid;
